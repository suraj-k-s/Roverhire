    ...
    <?php   
				...
				if(isset($_POST["btnpay"]))
				{
					//Email Code Start
                        ...
                        if(isset($_GET['bid']))
                        {
						$upb="update tbl_userrequest set payment_status=1  where userrequest_id=".$_GET['bid'];
                        }
                        else if(isset($_GET['urid'])){
						$upb="update tbl_userrequest set payment_status=10  where userrequest_id=".$_GET['urid'];
                        }
						$con->query($upb);	
						?>
				<script>
